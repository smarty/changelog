...
- international-autocomplete-api
  - string -> bool for Geolocation. String value is set for the user. 

## [1.31.2] - 2026-03-10
- international-street-api
  - Added minimum requirement check for international street lookup.

## [1.31.1] - 2026-03-06
- us-street-api
  - Fixed batch mode to set default match to enhanced, include custom parameters, and not exclude defaults in request.

## [1.31.0] - 2026-03-04
- us-street-api
  - Add the new IANA time zone fields to us-street-api and the new iana-timezone feature flag

## [1.30.0] - 2026-03-03
- international-postal-code-api
  - Added thoroughfare field 

## [1.29.3] - 2026-02-05
- Add AppendedHeader option for single-value header support for headers like (User-Agent)

## [1.29.2] - 2026-02-05
- Add SendUniversalLookupWithContext to us-enrichment-api and more tests

## [1.29.1] - 2026-02-04
- Context-Aware Retry with Retry-After Header Support
  - Retry-After Header Support (429 responses)
  - Context Cancellation Support
  - backOffRateLimit constant changed from 5 to 10 seconds
...
- us-enrichment-api
    - Expose the financial history struct to users of the sdk.
