...
### Added:
- International Street added `geocodeClassification` to the return Candidate Metadata.
...
### Added:
- Added `maxGroupResults` and `geolocation` fields to the International Address Autocomplete API Lookup.
...
### Changed:
- US Street API now always sends `match=strict` explicitly in requests instead of omitting it.
...
### Fixed:
- Removed a console log message

## [7.4.0] - 2025-11-20

### Added:
- Added occupant use data to International Street API metadata.
- Added financial history to US Enrichment property/principal response.

## [7.3.1] - 2025-11-19

### Changed:
- Updated dependencies to their latest versions to ensure the SDK stays current and secure

## [7.3.0] - 2025-11-17

### Added:
- Added component analysis to US Street Address API

### Fixed:
- Fixed false positive when checking credentials

## [7.2.0] - 2025-11-04

### Added:
- Added international postal code api.
