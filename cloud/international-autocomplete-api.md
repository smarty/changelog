...
## 2.2.28 - 2026-06-05
CHANGES:
- Allow premises with a hyphen to be typed without one, and vice versa
...
- Fixed an issue where submitting an `address_id` may not return a result. 

## 2.2.18 - 2026-01-20
CHANGES:

- Added support for Bouvet Island (BVT), Heard Island and McDonald Islands (HMD), and Kosovo (XKX). 
...
- Removed 101st summary result containing address_id to remaining entries.

## 2.2.14 - 2025-09-16
CHANGES:

- Fixed the detailed results `street` line formatting for the following countries:
  - GBR
  - MYS
  - JPN
...
- Filters can now be fuzzy for NLD (Netherlands) queries. Prior filters needed to match exactly including whitespace, hyphens, etc.
