...
## 3.8.39 - 2026-09-11
CHANGES:
- Fixed issue in the Postal Code API route that could return malformed NZL postal codes. 

## 3.8.37 - 2026-09-11
CHANGES:
- Fixed issue where US and US Territory requests were not returning verification_status and address_precision.
- Fixed issue where Kosovo requests were returning XKK. It now returns XKX as the country_iso_3. 
...
## 3.8.32 - 2026-07-14
CHANGES:
- Reverted the ISO3 country code for Kosovo from XKK back to XKX. 

## 3.8.31 - 2026-07-10
CHANGES: 
- Improved accuracy of address and geocode precision levels for US territories and Compact of Free Association states.
- Fix missing max_address_precision field in USA, US Territory, and COFA states. 
- Update country ISO3 code from XKX to XKK for Kosovo. 

## 3.8.28 - 2026-06-30
CHANGES:
- These changes will be deployed throughout the day.
  - An internal change that should not affect results.


## 3.8.25 - 2026-06-22
CHANGES:
- These changes will be deployed throughout the day.
  - New June data: 2026Q2.1-0
  - `occupant_use` is now available for the following countries: Australia, Belgium, Brazil, Canada, Netherlands, Spain, United Kingdom (GBR)
  - An internal change that should not affect results.
...
- These changes will be deployed throughout the day.
  ...
  - Changes for Turkey (TUR)
    - District information is now being returned in Locality instead of SubAdministrativeArea.
