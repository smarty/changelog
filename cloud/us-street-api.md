...
### Changed
- Fixed a bug where the PMB number was being truncated
- Improved support for authoritative alias matching
...
- Improved matching for street suffix

## 5.18.2 - 2026-09-09
We are beginning our phased rollout of us-street-api 5.18.2. This process is scheduled to be completed by 2026-09-12 00:00:00 UTC. Some customers might notice slightly inconsistent results between subsequent calls for the same inputs. This is expected behavior.
...
### Added
- Started support for ACP and SAH address programs
...
### FIXED
- Improved handling of inputs with excessive hyphens.

## 5.16.10 - 2026-07-20

### CHANGED
- Improved handling of inputs that lack proper spacing and capitalization.
- Improved handling of inputs that contain an addressee.
- Improved handling of inputs that contain a secondary.

## 5.16.9 - 2026-07-16

### CHANGED
- Improved handling of inputs that lack proper spacing.

## 5.16.8 - 2026-07-13

### CHANGED
- Improved handling of hyphens in strict match.
- Improved accuracy of U# footnotes for strict match.
...
- Improved accuracy of M# footnotes.
- Improved matching of addresses containing a hyphen.
- Improved invalid secondary accuracy for enhanced match.
...
## 5.15.2 - 2026-04-06
We are beginning our phased rollout of us-street-api 5.15.2. This process is scheduled to be completed by 2026-04-08 00:00:00 UTC. Some customers might notice slightly inconsistent results between subsequent calls for the same inputs. This is expected behavior.

### CHANGED
- Improved matching for Puerto Rico addresses in Enhanced mode, especially for addresses with urbanization information

## 5.15.1 - 2026-03-30
We are beginning our phased rollout of us-street-api 5.15.1. This process is scheduled to be completed by 2026-04-01 00:00:00 UTC. Some customers might notice slightly inconsistent results between subsequent calls for the same inputs. This is expected behavior.

### ADDED
- Added smarty_key_ext as a return field.

### FIXED
- Non-standard highway names will return with more consistent capitalization.

## 5.14.12 - 2026-03-11
We are beginning our phased rollout of us-street-api 5.14.12. This process is scheduled to be completed by 2026-03-12 00:00:00 UTC. Some customers might notice slightly inconsistent results between subsequent calls for the same inputs. This is expected behavior.
...
### FIXED
- Improved handling of inputs matching to an address with an X# (default unique ZIP code) footnote in enhanced mode.

## 5.14.5 - 2025-11-20
We are beginning our phased rollout of us-street-api 5.14.5. This process is scheduled to be completed by 2025-11-22 00:00:00 UTC. Some customers might notice slightly inconsistent results between subsequent calls for the same inputs. This is expected behavior.

### CHANGED
- Improved accuracy of C# and F# footnotes.
